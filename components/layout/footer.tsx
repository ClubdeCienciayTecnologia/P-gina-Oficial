...
export default function Footer() {
  return (
    <footer className="w-full border-t bg-gradient-to-br from-blue-900 to-blue-950 text-white py-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-blue-200">
              <li className="flex items-start">
                <MapPin className="h-5 w-5 mr-2 shrink-0 text-blue-300" />
                <span>Av. La Arqueología cuadra 2, San Borja, Lima, Perú</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 mr-2 text-blue-300" />
                <span>ccyt@cmspp.edu.pe</span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 mr-2 text-blue-300" />
                <span>(01) 225-9999</span>
              </li>
            </ul>
          </div>
        </div>
